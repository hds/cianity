...
#[test]
fn build_cross_stage_template_inherit() {
    assert_gitlab_snapshot("cross_stage_template_inherit");
}

#[test]
fn build_cross_stage_template_chain() {
    assert_gitlab_snapshot("cross_stage_template_chain");
}
